...
public class PasswordValidator implements Validator {
	...
	public void validate(FacesContext context, UIComponent component,
		...
		/*
		 * Monta um array de caracteres com o conteúdo da senha e percorre-o
		...
		if (password.length() < 7) {
			...
			throw new ValidatorException(
					new FacesMessage(
							FacesMessage.SEVERITY_ERROR, "A senha deve conter números, caracteres especiais e letras!",""));
